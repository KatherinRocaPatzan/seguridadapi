...
public class UserServiceTest {
    ...
    public void buscarTodosDebeFuncionar() {
        User user1 = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        User user2 = new User("2", "Angel", 19, 3333333, "angel@email.com", "password", null);
        ...
        assertEquals("katherin", users.get(0).getName());
        assertEquals("Angel", users.get(1).getName());
    }
    ...
    public void buscarPorIdDebeFuncionar() {
        User user = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        ...
        assertEquals("katherin", userDto.getName());
        assertEquals(18, userDto.getAge());
        assertEquals(2222222, userDto.getTell());
        assertEquals("katherin@email.com", userDto.getEmail());
    }
    ...
    public void buscarPorEmailDebeFuncionar() {
        ...
        when(userRepository.findByEmail("katherin@email.com")).thenReturn(Optional.of(user));

        UserDto userDto = userService.getByEmail("katherin@email.com");
    ...
    public void guardarDebeFuncionar() {
        UserDto userDto = new UserDto(null, "katherin", 18, 2222222, "katherin@email.com", "password", null);
        User user = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        ...
        assertEquals("katherin", savedUserDto.getName());
        assertEquals(18, savedUserDto.getAge());
        assertEquals(2222222, savedUserDto.getTell());
        assertEquals("katherin@email.com", savedUserDto.getEmail());
    }
    ...
    public void guardarUsuarioConIdNoDebeSobrescribir() {
        UserDto userDto = new UserDto("2", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        User user = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
    ...
    public void actualizarUsuarioDebeFuncionar() {
        User user = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        UserDto userDto = new UserDto("1", "katherin Updated", 20, 2222222, "katherin@email.com", "password", null);
        ...
        assertEquals("katherin Updated", updatedUserDto.getName());
        assertEquals(20, updatedUserDto.getAge());
        assertEquals("katherin_updated@email.com", updatedUserDto.getEmail());
    }

    @Test
    public void actualizarUsuarioNoExistenteDebeRetornarNulo() {
        UserDto userDto = new UserDto("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
    ...
    public void actualizarDebeLlamarSaveConDatosActualizados() {
        User user = new User("1", "katherin", 18, 2222222, "katherin@email.com", "password", null);
        UserDto userDto = new UserDto("1", "katherin Updated", 20, 2222222, "katherin_updated@email.com", "password", null);
    ...
    public void actualizarDebeValidarDatosDelUsuario() {
        UserDto userDto = new UserDto("1", null, 18, 2222222, "katherin@email.com", "password", null);
